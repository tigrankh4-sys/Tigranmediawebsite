        ...
        <div className="sc-inner">
          ...
          <div className="sc-projects-grid">
            ...
            <a href="/projecten/dakwerken/" className="sc-project-card sc-project-link" target="_blank" rel="noopener noreferrer">
              <Image className="sc-project-img" src="/images/dakwerken-cover.webp" alt="Van Damme Dakwerken — Concept site Mechelen" width={1920} height={1280} sizes="(max-width: 768px) 50vw, 300px" />
              <div className="sc-project-info">
