...
function ContactForm() {
  ...
  return (
    <form className="sc-form" onSubmit={handleSubmit}>
      ...
      <div className="sc-field"><label>Naam</label><input type="text" name="naam" placeholder="Jan Janssen" required /></div>
      <div className="sc-field"><label>Bedrijf</label><input type="text" name="bedrijf" placeholder="Jouw Bedrijf BV" /></div>
      <div className="sc-field"><label>E-mail</label><input type="email" name="email" placeholder="jan@bedrijf.be" required /></div>
      ...
      <div className="sc-field"><label>Bericht</label><textarea name="bericht" rows={4} placeholder="Vertel ons over uw project..." /></div>
